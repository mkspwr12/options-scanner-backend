...
class TestProviderRegistry:
    ...
    def test_register_mock_provider(self) -> None:
        self.registry.register("test-1", {"type": "MOCK", "enabled": True, "priority": 1})
    ...
    def test_get_best_provider_priority_order(self) -> None:
        self.registry.register("low", {"type": "MOCK", "enabled": True, "priority": 10})
        self.registry.register("high", {"type": "MOCK", "enabled": True, "priority": 1})
        pid, _ = self.registry.get_best_provider()
        assert pid == "high"

    def test_get_best_provider_skips_disabled(self) -> None:
        self.registry.register("disabled", {"type": "MOCK", "enabled": False, "priority": 1})
        self.registry.register("active", {"type": "MOCK", "enabled": True, "priority": 2})
        pid, _ = self.registry.get_best_provider()
        assert pid == "active"
    ...
    def test_unregister(self) -> None:
        self.registry.register("removeme", {"type": "MOCK", "enabled": True, "priority": 1})
        self.registry.unregister("removeme")
        with pytest.raises(ProviderError):
            self.registry.get_best_provider()

    def test_record_success(self) -> None:
        self.registry.register("p1", {"type": "MOCK", "enabled": True, "priority": 1})
    ...
    def test_get_rate_limit_info(self) -> None:
        self.registry.register(
            "p1",
            {"type": "MOCK", "enabled": True, "priority": 1, "rate_limit_max_per_hour": 100},
        )
    ...
    def test_clear(self) -> None:
        self.registry.register("a", {"type": "MOCK", "enabled": True, "priority": 1})
        self.registry.clear()
        with pytest.raises(ProviderError):
            self.registry.get_best_provider()
